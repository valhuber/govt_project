...
resourcename="govtproject"  # lower case, only
resourcegroup="govtproject_rg"
...
# git clone https://github.com/apilogicserver/govtproject.git
# cd govtproject
...
az group create --name govtproject_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group govtproject_rg --sku S1 --is-linux
az container create --resource-group govtproject_rg --name govtproject --image apilogicserver/govtproject:latest --dns-name-label govtproject --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//govtproject.westus.azurecontainer.io:5656'
